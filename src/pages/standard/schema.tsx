...
export const getStepSchemas = (getText: any) => [
  ...
  yup.object().shape({
    behandlere: yup.array().of(
      yup.object().shape({
        firstname: yup.string().required(getText('form.behandlere.firstname.required')),
        lastname: yup.string().required(getText('form.behandlere.lastname.required')),
        telefon: yup.string().required(getText('form.behandlere.telefon.required')),
      })
    ),
  }),
  yup.object().shape({
