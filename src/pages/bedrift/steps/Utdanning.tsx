...
import { Control, FieldErrors, FieldValues, useFieldArray, UseFormRegister } from 'react-hook-form';
...
export const Utdanning = ({ getText, register, control, errors }: UtdanningTypes): JSX.Element => {
