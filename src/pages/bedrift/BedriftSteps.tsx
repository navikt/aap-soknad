...
export const TypeStoette = ({ getText, errors, register }: StepType): JSX.Element => {
  const keys = ['utviklingsfase', 'oppstartEtterUtvikling', 'oppstartUtenUtvikling'];
  ...
  return (
    <RadioGruppe groupKey={'typeStoette'} getText={getText} error={errors.typeStoette?.message}>
      {radios}
    </RadioGruppe>
  );
};
